...
public class Mem extends javax.swing.JFrame {
    ...
    List<Integer> positivePins = Arrays.asList(11,10,9,6,5,3);
    List<Integer> negativePins = Arrays.asList(16,15,14,12,8,2);
    List<String> negativeInit = Arrays.asList("LOW","LOW","LOW","LOW","LOW","LOW");
    List<String> allHIGH = Arrays.asList("HIGH","HIGH","HIGH","HIGH","HIGH","HIGH");
    int ring = 5;
    ...
    private void vibration(int pin){
    ...
    private void vibrationGlove(int pin){
        int vibrationTime =3000;
        this.glove.activateMotor(positivePins, allHIGH);
        new java.util.Timer().schedule( 
            new java.util.TimerTask() {
                    @Override
                    public void run() {
                        glove.activateMotor(positivePins, negativeInit);
                    }
                }, 
                vibrationTime 
        );
